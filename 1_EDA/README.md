# Exploratery Data Analysis w/ SQL: Job Market Analysis

![Project overview](../Resources/images/1_1_Project1_EDA.png)

A SQL project analyzing the data engineer job market
using  real world job posting data. It demonstrates my ability
to **Write production-quality analytical SQL, design efficient queries, and turn business questions into data-drivien insights**
